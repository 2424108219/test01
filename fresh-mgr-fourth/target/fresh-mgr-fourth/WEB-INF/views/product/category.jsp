    ...
    <div class="heard-con">
        ...
        <div class="headr-nav">
            <ul>
                ...
                <li><a href="toShowProduct" style="color: #4AB344"><span style="color: #4AB344">全部产品</span></a></li>
...
<div class="content">
    ...
    <div class="recommand clear">
        <div class="rec-cont clear">
            ...
            <div class="rec-right" style="height: 1200px">
                <div style="color: seagreen;font-size: 18px;">产品列表</div>
                <hr style="color: #e7e7e7;"/>
                <p>
                <div class="search-con">
                    <form action="toCategoryCx" method="post">
                        <div class="search_text">
                            <input type="hidden" name="categoryId" value="${categoryId}">
                            <input type="text" class="input-con" placeholder="搜索商品" name="name"/>
                ...
                <form action="toCategoryCx" method="post">
                    <div class="details">
                        ...
                        --%>
                        <input type="hidden" name="categoryId" value="${categoryId}">
                        <a href="" class="details-mc">名称</a>
                        <a href="toShowTime?category=${categoryId}" class="details-sjsj">上架时间</a>
                        <a href="" class="details-pc">价格</a>
                        <input type="text" class="details-pc1" placeholder="￥" style="width: 40px;" name="price11"/>&nbsp;—&nbsp;
                        <input type="text" class="details-pc2" placeholder="￥ " style="width: 40px;" name="price12"/>
                        <input type="submit" class="details-pc3" value="搜索"/>
                    </div>
                    ...
                    <div class="bd">
                        <div class="bd1" style="display: block">
                            <c:forEach items="${products}" var="product">
                                <%--
                                                            <input type="hidden" name="price10" value="${product.price}">
                                --%>
                                <div class="rcr">
                                    <div class="rcr-top">
                                    ...
                                    <div class="rcr-bot">
                                        ...
                                        <div class="buy" style="height: auto;padding-bottom: 50px;margin-bottom: 50px">
